...
| `PROMPTS.md` | 2026-07-27 | Paste-ready kickoff prompts, one per phase, for driving the build by hand. | The build is no longer driven by pasting prompts — work is specified in `PHASE1.md`. **Removed from the repository on 2026-09-05** rather than archived: its later-phase prompts spelled out an unpublished design in implementable detail. |
